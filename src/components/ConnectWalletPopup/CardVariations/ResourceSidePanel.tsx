    ...
    if (isNeitherWalletConnected) {
      return (
        <>
          <InstructionBlock
            type="info"
            title="connect-wallet.resource-sidepanel.add-metamask-testnet"
            description="connect-wallet.resource-sidepanel.add-sepolia"
          ...
          <InstructionBlock
            title="connect-wallet.resource-sidepanel.download-massa-station"
            type="success"
            description="connect-wallet.resource-sidepanel.download-massa-station-and-create-wallet"
